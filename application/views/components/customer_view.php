<div class="p-4">
    <p class="h4 mb-4 hft">ข้อมูลลูกค้า</p>
    <div class="d-flex align-items-center">
        ...
        <div class="ms-auto">
            <a type="button" id="btnMycUs" href="<?php echo site_url('Customer/myCustomer') ?>" class="btn btn-primary me-3">ลูกค้าของฉัน</a>
            <a type="button" id="btnaddCstm" onclick="ShowaddCustomer()" class="btn btn-primary">+ เพิ่มลูกค้า</a>
        </div>
    </div>
